<template>
  <div>
    <index-navbar />
    <section
      class="header relative pt-32 items-center flex max-h-860-px"
    >
      <div class="container mx-auto items-center flex flex-wrap">
        <div class="w-full lg:w-6/12 xl:w-6/12 px-4">
          <div class="sm:pt-32">
            <h2 class="text-4xl font-semibold text-blueGray-600">
              Expert Writers - Committed to People, Committed to the Future
            </h2>
            <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
              Expert Writers is a one-stop-shop for custom written papers. It
              provides a custom paper writing service that serves students from
              across the world or anyone that would want to have a paper or
              article done for them.
            </p>
            <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
              It features 3 main platform, The client platform where a client
              can order a paper, an admin platform to manage the business and a
              writers platform where writers can claim jobs to work on.
            </p>
            <div class="mt-12">
              <a
                href="#"
    ...
    <section class="relative mt-48 bg-blueGray-100 pb-40 md:mt-40">
            ...
            >
              ...
              <blockquote class="relative mb-4 p-8">
                ...
                <h4 class="text-xl font-bold text-white">
                  Start your online writing business today with Expert Writers
                </h4>
                <p class="text-md mt-2 font-light text-white">
                  Starting your writing business just got easier. Expert Writers
                  brings togther all aspects of a writing empire that you would
                  need. From managing your writers to clients placing orders and
                  processing payments. The platform is easy to cutomise to your
                  liking. It's as easy as matching together pre-made components.
                </p>
              </blockquote>
            </div>
          </div>
              ...
              <div class="w-full px-4 md:w-6/12">
                <div class="relative mt-4 flex flex-col">
                  <div class="flex-auto px-4 py-5">
                    ...
                    <h6 class="mb-1 text-xl font-semibold">Payment</h6>
                    <p class="mb-4 text-blueGray-500">
                      Uses PayPal Checkout that present clients with the most
                      relevant online payment methods. It ensures fewer screens,
                      fewer clicks, and better checkout conversion.
                    </p>
                  </div>
                </div>
              ...
              <div class="w-full px-4 md:w-6/12">
                <div class="relative mt-4 flex min-w-0 flex-col">
                  <div class="flex-auto px-4 py-5">
                    ...
                    <h6 class="mb-1 text-xl font-semibold">Technology Used</h6>
                    <p class="mb-4 text-blueGray-500">
                      Developed with modern technology with the future in mind.
                      It's responsive and can be used with any device. Powered
                      by Vue 3, Tailwind CSS and Laravel.
                    </p>
                  </div>
                </div>
                <div class="relative flex min-w-0 flex-col">
      ...
      <div class="mt-16 flex flex-wrap justify-center text-center">
        <div class="w-full px-12 md:w-6/12 md:px-4">
          ...
          <p class="mt-4 mb-4 text-xl leading-relaxed text-blueGray-500">
            Expert Writers is a completly new product built using our past
            experience in web development to make it easy for you to start a
            writing empire.
          </p>
        </div>
      </div>
          ...
          <div class="lg:w-12/12 -mt-24 w-full px-4">
            <div class="flex flex-wrap">
              <div class="w-full px-4 lg:w-4/12">
                ...
                <a target="_blank" href='http://expertwritersdashboard.thetradinghut.net/login'>
                  <div
              ...
              <div class="w-full px-4 lg:w-4/12">
                ...
                <a target="_blank" href="http://expertwriters.thetradinghut.net/">
                  <div
                    class="relative mb-6 flex w-full min-w-0 flex-col break-words rounded-lg bg-white shadow-lg transition-all duration-150 ease-linear hover:-mt-4"
                  >
                    <img
      ...
      <div class="container mx-auto">
        ...
        >
          <div class="w-full text-center lg:w-8/12">
            ...
            <p class="mt-4 mb-4 text-lg leading-relaxed text-blueGray-500">
              Cause if you do, it can be yours now. Hit the button below to get
              yourself this platform and start your writing business today!
            </p>
      ...
      onApprove: function (data, actions) {
        return actions.order.capture().then(function (orderData) {
          ...
          successMessage.value =
            "Thank you for your purchase. We will send you a link to the download files to the email you used to make the payment within the hour. Transaction " +
            transaction.status +
            " Transaction ID: " +
            transaction.id;
        });
